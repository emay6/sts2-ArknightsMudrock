...
public class HighGround() : ArknightsMudrockCard(3,
    ...
    TargetType.Self)
{
    protected override IEnumerable<DynamicVar> CanonicalVars => [new PowerVar<HighGroundPower>(1)];
        ...
        CardPlay play)
    {
        ...
        await CommonActions.ApplySelf<HighGroundPower>(choiceContext, this);
    }
